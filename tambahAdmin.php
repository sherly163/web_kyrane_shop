...
<body style="width: 100%; height:800px">
    <?php
            ...
            if ( $_SERVER["REQUEST_METHOD"] == "POST") {
                ...
                if (empty($_POST["username"])) {
                    $usernameErr = "username is required";
                        ...
                        $cekdb = mysqli_query($conn, "SELECT username FROM admin WHERE username = '$username'");
        ...
        if($tesvalidnama=="TRUE" && $tesvalidnohp=="TRUE" && $tesvalidemail=="TRUE" && $tesvalidusername=="TRUE" && $tesvalidpass=="TRUE"){
            ...
            $sendpass = md5($pass);
            $sqlttambah = "INSERT INTO admin (nama_admin,username,Password,No_HP,email) VALUES ('$sendnama','$sendusername','$sendpass','$sendnohp','$sendemail')";
    ...
    <div class="pagelogin" style="width: 100%;">
        ...
        <div class="rightpage">
            <div class="formlog">
                ...
                <br>
                <p><a href="settingadmin.php">Back</a></p>
            </div>
        </div>
    </div>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <a href="settingadmin.php"> <button type="button" class="btn btn-primary">Go to Login</button></a>
      </div>
    </div>
  </div>
</div>

...
<body style="background-color: #f5f5f5;">
      ...
      <?php
            ...
            $transaksi = mysqli_query($conn,"SELECT * FROM transaksi LEFT JOIN  customer ON transaksi.idcustomer = customer.ID_customer LEFT JOIN barang ON transaksi.idbarang = barang.ID_barang LEFT JOIN  alamat_customer ON transaksi.idalamat = alamat_customer.ID_alamat WHERE transaksi.idtransaksi = '$idtransaksi' AND customer.ID_customer = '$idcust'");
        ...
        <div class="detail" style="width:100%">
            <h2 align="center" style="margin-top:24px">Detail Transaksi</h2>
            <div class="isi" style="width: 80%; margin:0 auto; margin-top:40px">
            
                <table style="width: 85%; margin:0 auto;">
                    <tr>
                        <td colspan="3"><h5 align="left">Detail Transaksi</h5></td>
                    </tr>
                    <tr>
                ...
                <table style="width: 85%; margin:0 auto; margin-top:24px">
                    <tr>
                        <td colspan="3"><h5 align="left">Detail Pembeli</h5></td>
                    </tr>
                    <tr>
                ...
                <table style="width: 85%; margin:0 auto;">
                     <tr>
                        <td colspan="3"><h5 align="left">Detail Barang</h5></td>
                    </tr>
                    <tr>
            ...
            <a href="transaksi.php" style="margin-top: 30px;"><button type="button" class="btn btn-warning"><i class="fa-solid fa-caret-left"></i>BACK</button></a>
            </div>

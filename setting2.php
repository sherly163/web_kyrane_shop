...
<body style="background-color: #f5f5f5;">
      ...
      <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <div class="container-fluid" style="background-color: #D9AC6B;">
          <a class="navbar-brand" href="index.php"><img src="img/logonav.jpg" class="logoinnav" style="height: 50px;"></a>
            ...
            <div class="row justify-content-md-center" style="width: 100%;">
              <div class="col" style="margin-top:20px">
                <ul class="navbar-nav me-auto mb-5 mb-lg-0 align-middle" >
                  <li class="nav-item">
                    <a class="nav-link active" aria-current="page" href="index.php">Kyrane Shop</a>
                  </li>
                  <li class="nav-item">
      ...
      <div class="pagesetting">
        ...
        ?>
          ...
          <tr>
            ...
            <td>
              <button type="button"  class="btn btn-outline-success" data-bs-toggle="modal" data-bs-target="#editNama">
          ...
          <tr>
            ...
            <td>
              <a href="gantipassword.php"><button type="button"  class="btn btn-outline-success">
      ...
      <div class="pagesettingalamat">
        <div class="textalamat">
          <!-- <button type="button" id="btnAlamat" class="btn btn-outline-success" data-bs-toggle="modal" data-bs-target="#TambahAlamat">Tambah Alamat  <i class="fa-solid fa-plus"></i></button> -->
          <?php
                $alamatuser = 1;
                    ...
                    <tr>
                      <td>
                        <form method="post">
                         ...
                         <button type="button"  class="btn btn-outline-success" data-bs-toggle="modal" data-bs-target="#editAlamat<?=$idalamat;?>">
                          <i class="far fa-edit"></i>Edit</button>
                        </form>
                      </td>
                      ...
                      <td>
                        <form method="post">
                          <input type="hidden" name="idalamat" value="<?=$idalamat;?>">
                          <a href="setting.php"><button type="submit" name="HapusAlamat" class="btn btn-outline-danger" ><i class="fa-regular fa-trash"></i>delete</button>
                        </form>
                      </td>
                    </tr>
                  </table>
                ...
                <div class="modal-content">
                  ...
                  <div class="modal-footer">
                   <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                    <button type="submit" class="btn btn-success" name="EditAlamat">Update</button>
                    </form>
                  </div>
                </div>
              </div>
